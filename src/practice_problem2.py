...
def run_test_practice_problem2a():
    ...
    print('Test 1:')
    expected = [2, 3, 4, 5, 6]
    actual = practice_problem2a([1, 2, 3, 4, 5], 1)
    print('expected:', expected)
    print('actual:', actual)

    print('Test 2:')
    expected = [3, 5, 7, 9]
    actual = practice_problem2a([1, 3, 5, 7], 2)
    print('expected:', expected)
    print('actual:', actual)

    print('Test 3:')
    expected = [5, 10, 15, 20]
    actual = practice_problem2a([0, 5, 10, 15], 5)
    print('expected:', expected)
    print('actual:', actual)

    print('Test 4:')
    expected = [30]
    actual = practice_problem2a([25], 5)
    print('expected:', expected)
    print('actual:', actual)
...
def practice_problem2b(sequence):
    ...
    for k in range(len(sequence)):
        for j in range(len(sequence[k])):
            new_string = new_string + (sequence[k])[j]
            break
    return new_string
